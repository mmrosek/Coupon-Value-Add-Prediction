...
def train_mlp(features_std, y, num_iter, init_points, max_layer_1, max_layer_2):
    ...
    def mlp_cv(max_iter, num_nodes_1, num_nodes_2):
    
        # Determining architecture
        num_nodes_1 = int(num_nodes_1)    
        num_nodes_2 = int(num_nodes_2)        
        num_nodes_list = [num_nodes_1,num_nodes_2]
    ...
    mlp = MLPClassifier(max_iter = max_iter, hidden_layer_sizes=np.array([num_nodes_1,num_nodes_2]), random_state=2, learning_rate_init = .001, early_stopping = True)
